...
register_mjlab_task(
  task_id="Unitree-G1-Tracking-Robust-History",
  env_cfg=unitree_g1_robust_history_tracking_env_cfg(),
  play_env_cfg=unitree_g1_robust_history_tracking_env_cfg(play=True),
  rl_cfg=unitree_g1_tracking_ppo_runner_cfg(),
  runner_cls=MotionTrackingOnPolicyRunner,
)
