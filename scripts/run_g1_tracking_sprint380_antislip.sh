...
run_name="${RUN_NAME:-tracking_sprint380_antislip_4gpu_8192_each_20}"
load_run="${LOAD_RUN:-2026-08-25_10-10-58_tracking_sprint380_4gpu_8192_each_continue25_45}"
load_checkpoint="${LOAD_CHECKPOINT:-model_20.pt}"
motion_file="${MOTION_FILE:-src/assets/motions/g1/lafan1_run1_subject2_112s_115s_speed380.npz}"
...
exec env CUDA_VISIBLE_DEVICES="$gpu_ids" "$python_bin" \
  ...
  --agent.algorithm.learning-rate 0.00005 \
