...
exec env \
  ...
  scripts/train.py Unitree-G1-Sprint-E2C-Symmetry \
  ...
  --agent.run-name sprint_e2c_symmetry_aug_4096_100 \
  --agent.logger tensorboard \
  --agent.resume True \
  --agent.load-run 2026-08-24_03-30-01_sprint_e2b1_yaw050_4096_100 \
