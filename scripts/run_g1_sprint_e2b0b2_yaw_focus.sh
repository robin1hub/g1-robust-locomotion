...
exec env \
  ...
  scripts/train.py Unitree-G1-Sprint-E2B0B2-Yaw-Focus \
  ...
  --agent.run-name sprint_e2b0b2_yaw_focus_4096_100 \
  --agent.logger tensorboard \
  --agent.resume True \
  --agent.load-run 2026-08-24_02-33-07_sprint_e2b0b_reward_fix_4096_100 \
  --agent.load-checkpoint model_99.pt \
