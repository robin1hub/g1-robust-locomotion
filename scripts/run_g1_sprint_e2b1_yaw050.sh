...
exec env \
  ...
  scripts/train.py Unitree-G1-Sprint-E2B1-Yaw050 \
  ...
  --agent.run-name sprint_e2b1_yaw050_4096_100 \
  --agent.logger tensorboard \
  --agent.resume True \
  --agent.load-run 2026-08-24_03-17-31_sprint_e2b0b3_yaw030_4096_100 \
