...
exec env \
  ...
  scripts/train.py Unitree-G1-Sprint-E2B0B3-Yaw030 \
  ...
  --agent.run-name sprint_e2b0b3_yaw030_4096_100 \
  --agent.logger tensorboard \
  --agent.resume True \
  --agent.load-run 2026-08-24_02-57-13_sprint_e2b0b2_yaw_focus_4096_100 \
