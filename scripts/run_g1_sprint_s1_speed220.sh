...
exec env \
  ...
  scripts/train.py Unitree-G1-Sprint-S1-Speed220 \
  ...
  --agent.run-name sprint_s1_speed220_4096_300 \
  --agent.logger tensorboard \
  --agent.resume True \
  --agent.load-run 2026-08-24_03-56-37_sprint_e2c_symmetry_aug_4096_100 \
