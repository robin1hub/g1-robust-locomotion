...
exec env \
  ...
  scripts/train.py Unitree-G1-Sprint-S3-Speed340 \
  ...
  --agent.run-name sprint_s3_speed340_4096_400 \
  --agent.logger tensorboard \
  --agent.resume True \
  --agent.load-run 2026-08-25_02-59-46_sprint_s2_speed280_4096_400 \
  --agent.load-checkpoint model_399.pt \
